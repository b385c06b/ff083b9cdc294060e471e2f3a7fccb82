...
//	}
	...
	*/
	...
	hge->Gfx_SetClipping(offsetval, 0, SCREEN_WIDTH-2*offsetval, SCREEN_HEIGHT);
	...
	matView.m[1][0] = 0.0f;
	matView.m[1][1] = scaleval;
	matView.m[1][2] = 0.0f;
	matView.m[1][3] = 0.0f;

	matView.m[2][0] = 0.0f;
	matView.m[2][1] = 0.0f;
	matView.m[2][2] = scaleval;
	matView.m[2][3] = 0.0f;

	matView.m[3][0] = offsetval;
	matView.m[3][1] = 0.0f;
	matView.m[3][2] = 0.0f;
	matView.m[3][3] = 1.0f;

	D3DXMATRIX matProj;
	matProj.m[0][0] = scaleval;
	matProj.m[0][1] = 0.0f;
	matProj.m[0][2] = 0.0f;
	matProj.m[0][3] = 0.0f;
	...
	matProj.m[2][0] = (M_CLIENT_CENTER_X-M_ACTIVECLIENT_CENTER_X)/(M_CLIENT_HEIGHT/2)*scaleval;
	matProj.m[2][1] = 0.0f;
	matProj.m[2][2] = -1.0f;
	matProj.m[2][3] = -1.0f;
