...
enum{
	...
	SCR_CTCONTROL	= SCR_CONTROL - SCR_TYPEBEGIN,
	SCR_CTSTAGE		= SCR_STAGE - SCR_TYPEBEGIN,
	SCR_CTEDEF		= SCR_EDEF - SCR_TYPEBEGIN,
	SCR_CTSCENE		= SCR_SCENE - SCR_TYPEBEGIN,
	SCR_CTFUNCTION	= SCR_FUNCTION - SCR_TYPEBEGIN,
	SCR_CTEVENT		= SCR_EVENT - SCR_TYPEBEGIN,
